...
wget https://github.com/armbian/build/raw/master/patch/kernel/rockchip64-dev/RK3399-enable_1.5_2.0_ghz_cpufreq_opp.patch
git apply RK3399-enable_1.5_2.0_ghz_cpufreq_opp.patch
cd ../
